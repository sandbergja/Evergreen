...
describe('CourseListComponent', () => {
    ...
    it('can navigate to several pages', () => {
        ...
        expect(window.open).toHaveBeenCalledWith('https://my-evergreen.com/eg2/en-US/staff/admin/local/asset/course_list/20');
        expect(window.open).toHaveBeenCalledWith('https://my-evergreen.com/eg2/en-US/staff/admin/local/asset/course_list/21');
    });
});
