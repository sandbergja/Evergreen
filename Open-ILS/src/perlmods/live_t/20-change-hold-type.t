...
subtest 'open-ils.circ.holds.change_type.possible_targets', sub {
    ...
    subtest 'copy to volume hold', sub {
        ...
        is scalar @{$results}, 1, 'found 1 potential call number';
        is $results->[0]->label, 'FIC 223', 'found call number with the correct label';
    ...
    subtest 'copy to part hold', sub {
        ...
        is scalar @{$results}, 1, 'found 1 potential part';
        is $results->[0]->label, 'DISC 4', 'found part with the correct label';
    ...
    subtest 'copy to metabib hold when there are peer bibs', sub {
        ...
        is scalar @{$results}, 5, 'found 5 potential metarecords (1 from the call number and 4 from the peers)';
        ok none { $U->is_event($_) } @{$results}, 'none of the metarecords are ILS events';
    ...
    subtest 'copy to title hold when there are peer bibs', sub {
        ...
        is scalar @{$results}, 5, 'found 5 potential records (1 from the call number and 4 from the peers)';
        ok none { $U->is_event($_) } @{$results}, 'none of the records are ILS events';
    ...
    subtest 'part to title hold', sub {
        ...
        is scalar @{$results}, 1, 'found 1 title';
        is $results->[0]->id, 53, 'it has the correct bre id!';
    ...
    subtest 'volume to copy hold', sub {
        ...
        is scalar @{$results}, 5, 'found 5 potential items';
        ok none { $U->is_event($_) } @{$results}, 'none of the items are ILS events';
    ...
    subtest 'volume to part hold', sub {
        ...
        is scalar @{$results}, 4, 'found all 4 parts that are on the title';
        ok none { $U->is_event($_) } @{$results}, 'none of the parts are ILS events';
    ...
    subtest 'volume to title hold', sub {
        ...
        is scalar @{$results}, 1, 'found 1 title';
        is $results->[0]->id, 1, 'it has the correct bre id!';
